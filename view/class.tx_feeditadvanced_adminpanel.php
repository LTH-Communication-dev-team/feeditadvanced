...
class tx_feeditadvanced_adminpanel {
	...
	function getAdmPanelFields() {
		...
		<input type="hidden" name="TSFE_ADMIN_PANEL[preview_showHiddenRecords]" value="0" id="TSFE_ADMIN_PANEL-preview_showHiddenRecords" />
		<input type="hidden" name="TSFE_ADMIN_PANEL[display_preview]" value="1" />
		...
		';
//' . ($GLOBALS['BE_USER']->adminPanel->extGetFeAdminValue('preview', 'showHiddenRecords') ? 1 : 0) . '
//			// hook to add additional hidden fields
	...
	protected function getConfigurationJavascript() {
		...
		$labels = array(
			'dropMessage' => $GLOBALS['LANG']->sL('LLL:EXT:extend_feeditadvanced/locallang.xml:js.dropMessage'),
			...
			'newContentElement' => $GLOBALS['LANG']->sL('LLL:EXT:feeditadvanced/locallang.xml:js.newContentElement').'<span onclick="closeIframe();return false;" class="fancybox-close"></span><span onclick="loadHelp();return false;" class="help-button">',
			'newPage' => $GLOBALS['LANG']->sL('LLL:EXT:feeditadvanced/locallang.xml:js.newPage'),
			'editContentElement' => $GLOBALS['LANG']->sL('LLL:EXT:feeditadvanced/locallang.xml:js.editContentElement').'<span onclick="closeIframe();return false;" class="fancybox-close"></span><span onclick="loadHelp();return false;" class="help-button">',
