...
//Add hook to extend js in htmlarea Browselinks
//$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/rtehtmlarea/mod3/class.tx_rtehtmlarea_browse_links.php']['extendJScode'][] = 'EXT:feeditadvanced/hooks/class.tx_feeditadvanced_extendjs.php:tx_feeditadvanced_extendjs';
...
$TYPO3_CONF_VARS['SYS']['locallangXMLOverride']['sv']['EXT:lang/locallang_tsfe.php']['EXT:' . $_EXTKEY] = t3lib_extMgm::extPath($_EXTKEY) . "locallang_sv.xml";
$TYPO3_CONF_VARS['SYS']['locallangXMLOverride']['sv']['EXT:lang/locallang_tsfe.xml']['EXT:' . $_EXTKEY] = t3lib_extMgm::extPath($_EXTKEY) . "locallang_sv.xml";
